    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      <View style={{ flex: 1, marginHorizontal: 22 }}>
        ...
        <TouchableOpacity style={{
          ...
          <Image source={Facebook} style={{ width: 31, height: 31, marginLeft: 51 }} /> 
        <Text style={{ 
          fontSize: 17,
          fontWeight:500, 
          color:'#000',
        ...
        <TouchableOpacity style={{
          ...
          <Image source={Google}style={{ width: 26, height: 26, marginLeft: 60 }} /> 
        <Text style={{ 
          fontSize: 17,
          fontWeight:500, 
          color:'#000',
        ...
        <TouchableOpacity style={{
          ...
          <Image source={Vector}style={{ width: 22, height: 26, marginLeft: 68 }} /> 
        <Text style={{ 
          fontSize: 17,
          fontWeight:500, 
          color:'#000',
